...
class TCLGenerator:
    ...
    def attribution(self):
        ...
        script += self.section_dividers
        script += '# Script Automatically Generated by Sys-Gen\n'
        script += '# \n'
        script += '# Script Author: Mohammed Essa Elbtity\n'
        script += '# Modified by: Peyton Chandarana\n'
        script += '# \n'
        return script
    ...
    def write(self):
        with open(
            ...
            f.write(self.attribution())
            f.write(self.setup())
            f.write(self.rtl_files())
            f.write(self.design_constraints())
            f.write(self.timing_closure())
