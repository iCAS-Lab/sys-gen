...
while {1} {
	...
	set essa_file [open "./reports/dump_timing.txt" r] 
	set essa_file_content [read $essa_file]
	close $essa_file
	file delete $deleted_name
	if {[regexp {VIOLATED} $essa_file_content]} {
	...
	} elseif {[regexp {MET} $essa_file_content] && $violation_counter < 4} {
